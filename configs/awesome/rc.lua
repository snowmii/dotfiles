...
awful.screen.connect_for_each_screen(function(s)
    ...
    local update_tags = function(self, c3)
        ...
        elseif #c3:clients() == 0 then
            ...
            else self.fg = beautiful.fg_normal
            end
        end
    end
    ...
    s.mytaglist = awful.widget.taglist {
		...
		widget_template = {
			{
				{ id = 'icon_role', font = "JetBrainsMono Nerd Font 14", widget = wibox.widget.textbox, valign = "center", align = "center" },
				id = 'margin_role',
				top = 2,
				bottom = 4,
				left = 2,
    ...
    s.mywibox = awful.wibar({ 
        ...
        height = 24, border_width = 6, border_color = "00000000" 
    })
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey }, "w", function() awful.util.spawn("rofi -show drun") end,
...
awful.rules.rules = {
    ...
    -- App rules
     { rule = { class = "Google-chrome" },
       properties = { screen = awful.screen.focused(), tag = "3", fullscreen = true } },
     { rule = { class = "discord" },
       properties = { 
           screen = awful.screen.focused(), tag = "2", 
           fullscreen = true, placement = awful.placement.center
       }
     }
}
-- }}}
...
awful.spawn.with_shell('xinput set-prop "ELAN0501:00 04F3:3019 Touchpad" "libinput Tapping Enabled" 1')
